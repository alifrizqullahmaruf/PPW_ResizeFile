        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('update', $users) }}" enctype="multipart/form-data">
                    ...
                    <img src="{{ asset('storage/photos/' . $users->photo) }}" width="150px" style="display: block; margin: 0 auto;" class="mt-3">
                    ...
                    <div class="mb-3 row">
                        <button type="submit" class="col-md-3 offset-md-5 btn btn-primary">Save Changes</button>
                    </div> 

                    <div class="mb-3 row">
                        <a href="{{ route('dashboard') }}" class="col-md-3 offset-md-5 btn btn-secondary">Back to dashboard</a>
                    </div>
                </form>
